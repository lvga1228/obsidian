...
**分类:** ⚙️ MLOps
**Skill ID:** `openai-models`

> OpenAI's specialized multimodal models — CLIP for vision-language tasks (zero-shot classification, image search) and Whisper for speech recognition (99-language transcription, translation). Both MIT-licensed with high GitHub stars.
