...
skill_id: gstack-plan-tune
---

# Gstack Plan Tune

**分类:** Uncategorized
**Skill ID:** `gstack-plan-tune`
...
7. **"Turn it off" / "disable"** → `~/.hermes/skills/gstack/bin/gstack-config set question_tuning false`
8. **"Turn it on" / "enable"** → `~/.hermes/skills/gstack/bin/gstack-config set question_tuning true`
