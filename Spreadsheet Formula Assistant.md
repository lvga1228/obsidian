...
**分类:** 📊 Data Science
**Skill ID:** `spreadsheet-formula-assistant`

> Write, debug, and optimize Excel / Google Sheets formulas, pivot tables, array formulas. Translate between Chinese and English spreadsheet contexts. Adapted from ComposioHQ/awesome-codex-skills.
